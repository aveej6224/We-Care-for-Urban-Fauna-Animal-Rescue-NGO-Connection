					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link"
							href="/We_Care/MainAction.do?subaction=acceptUser">Accept
								User</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/We_Care/JSP/assignUser.jsp">Assign User</a></li>
						<li class="nav-item">
		...
		<table id="myTable" class="table table-striped"
			...
			<tbody>
				<tr>
					...
					<td><a onclick="deleteRow()"> <img
							src="/We_Care/Images/approve.png" alt="Approve"
							style="width: 30px;">
					</a> <a onclick="deleteRow()"> <img
							src="/We_Care/Images/reject.jpg" alt="Reject"
							style="width: 30px;">
					</a></td>
				</tr>
				<tr>
					...
					<td><a onclick="acceptRequest()"> <img
							src="/We_Care/Images/approve.png" alt="Approve"
							style="width: 30px;">
					</a> <a onclick="acceptRequest()"> <img
							src="/We_Care/Images/reject.jpg" alt="Reject"
							style="width: 30px;">
					</a></td>
				</tr>
