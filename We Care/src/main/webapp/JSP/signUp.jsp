	...
	<form name="myForm">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container-fluid">
				<a class="navbar-brand" href="/We_Care/HTML/Welcome.html">We
					Care</a>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent"
					...
					<form class="d-flex">
						...
						<a class="navbar-brand" href="/We_Care/HTML/Login.html">Login</a>
						<a class="navbar-brand"
							href="/We_Care/MainAction.do?subaction=signUp">Sign Up</a>
										...
										<form class="mx-1 mx-md-4">
											...
											<div class="d-flex flex-row align-items-center mb-4">
												...
												<div class="form-outline flex-fill mb-0">
													...
													</select> <label class="form-label" for="form3Example1c">Registering
														as:</label>
												</div>
											</div>
											...
											<div class="d-flex flex-row align-items-center mb-4">
												...
												<div class="form-outline flex-fill mb-0">
													<input type="text" id="name" class="form-control" /> <label
														id="tempName" class="form-label" for="form3Example1c">
														Name</label>
												</div>
											</div>
											...
											<div class="d-flex flex-row align-items-center mb-4">
												...
												<div class="form-outline flex-fill mb-0">
													<input type="email" id="email" class="form-control"
														onclick="checkEmail()" /> <label id="tempEmail"
											...
											<div class="d-flex flex-row align-items-center mb-4">
												...
												<div class="form-outline flex-fill mb-0">
													<select class="form-control" id="country"
														onchange="populateState(this.value);">
											...
											<div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
												<button type="button" class="btn btn-primary btn-lg"
													onclick="singUp();">Register</button>
											</div>
